function [sol, info] = fbpd(x_0, F, param)
...
%   See also: solver 
%
%   Url: https://lts2.epfl.ch/unlocbox/doc/solver/solvep.php
...
Fp = F(1:2); 
Fg = F(3);
param.gamma = 1/Fg{1}.beta; 
param.stopping_criterion = 'rel_norm_primal_dual';
